...
from Vidiator.audio.edge_voice_module import EdgeTTSVoiceModule
from Vidiator.audio.eleven_voice_module import ElevenLabsVoiceModule
from Vidiator.config.api_db import ApiKeyManager
from Vidiator.config.languages import (EDGE_TTS_VOICENAME_MAPPING,
                                       ELEVEN_SUPPORTED_LANGUAGES, Language)
from Vidiator.engine.content_video_engine import ContentVideoEngine
from Vidiator.gpt import gpt_chat_video
...
class VideoAutomationUI(AbstractComponentUI):
    def __init__(self, VideoUI: gr.Blocks):
            ...
            if self.state == Chatstate.ASK_ORIENTATION:
                ...
                if "yes" in message.lower():
                    ...
                    try:
                        ...
                        current_url = self.VideoUI.share_url+"/" if self.VideoUI.share else self.VideoUI.local_url
    ...
    def initialize_conversation(self):
        ...
        self.video_html = ""
        self.videoVisible = False
        return [[None, "🤖 Welcome to Vidiator.AI! 🚀 I'm Bot aiming to simplify and automate your video editing tasks.\nLet's get started! 🎥🎬\n\n Do you want your video to be in landscape or vertical format? (landscape OR vertical)"]]
